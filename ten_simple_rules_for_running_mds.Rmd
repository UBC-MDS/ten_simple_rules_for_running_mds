---
title: "Ten simple rules for running a Master’s of Data Science program"
author: 
- Micheal A. Gelbart
- Tiffany A. Timbers
date: "`r Sys.Date()`"
...
we think have been key to the success of launching and running this successful program.
